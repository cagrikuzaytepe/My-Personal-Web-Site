      ...
      <div className="hero--section--content--box">
        <div className="hero--section--content">
          ...
          <p className="hero--section-description">
              ...
              On November 13th, I conducted a discussion on cybersecurity with Levent Ertaul, the head of the Computer Science department at California State University. Furthermore, I am currently working on a hackathon focusing on mobile applications this year. I actively participated in the Career Fair 22 and 23.          
          </p>            
      ...
      <div className="about--section--alt">
        ...
        <div className="text-box">
          ...
          <p className="meetup-description">  
            Images from our ProgrammixV event that took place from October 30th, providing training in 5 different programming languages over 3-4 weeks.
          </p>
        </div>
        ...
        <div className="text-box">
          ...
          <p className="meetup-description">
            Images from DevFest 23, which is the largest developer festival in Turkey.
          </p>
        </div>
      </div>
    </section>
